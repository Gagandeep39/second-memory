...
10. Replace timestampMills to timestamp in json file
11. Add option to switch between speech recognition and google coloud api (Handle no internet scenario as well when using google cloud api)
